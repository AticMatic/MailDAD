...
class AuthServiceProvider extends ServiceProvider
{
    ...
    protected $policies = [
        ...
        \Acelle\Model\PaymentGateway::class => \Acelle\Policies\PaymentGatewayPolicy::class,
        \Acelle\Model\PlanVerification::class => \Acelle\Policies\PlanVerificationPolicy::class,
