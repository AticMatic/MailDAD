...
class CustomerController extends Controller
{
    ...
    public function show($uid)
    {
        ...
        $result = [
            ...
            'users' => $customer->users->map(function ($user, $customer) {
                return [
                    'uid' => $user->uid,
                    'api_token' => $user->api_token,
                    'one_time_api_token' => $user->one_time_api_token,
    ...
    public function assignPlan(Request $request, $uid, $plan_uid)
    {
        ...
        try {
            ...
            \DB::transaction(function () use ($plan, $customer, $request) {
                ...
                if ($request->disable_billing && $request->disable_billing !== 'false') {
                    $subscription->getItsOnlyUnpaidInitInvoice()->paySuccess();
                }
            });
        } catch (\Throwable $e) {
