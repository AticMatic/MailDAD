...
class SubscriptionPolicy
{
        ...
        switch ($role) {
            case 'admin':
                $can = $subscription->getUnpaidInvoice() &&
                    $subscription->getUnpaidInvoice()->getLastAndItIsPendingTransaction() &&
                    $subscription->getUnpaidInvoice()->getLastAndItIsPendingTransaction()->allowManualReview();
                break;
            case 'customer':
                $can = false;
                break;
    ...
    {
        $can = $subscription->plan->type == \Acelle\Model\PlanGeneral::TYPE_GENERAL && $subscription->isActive();
