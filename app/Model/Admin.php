...
class Admin extends Model
{
    ...
    {
        // Create customer
        [$validator, $customer] = \Acelle\Model\Customer::createCustomer(
            $name = $this->user->displayName(get_localization_config('show_last_name_first', $this->getLanguageCode())),
        ...
        // set default role
        $this->user->setRole(\Acelle\Model\Role::getDefaultAdminRole());

        // set customer
        $customer->addUser($this->user);
