...
Route::group(['namespace' => '\Acelle\Http\Controllers', 'middleware' => ['not_installed', 'auth']], function () {
...
Route::group(['namespace' => '\Acelle\Http\Controllers', 'middleware' => ['not_installed', 'auth', 'frontend', '2fa']], function () {
    ...
    Route::post('subscription/{invoice_uid}/{payment_method_id}/auto-charge', 'SubscriptionController@autoCharge');

    Route::post('checkout/{invoice_uid}/{payment_method_id}/auto-charge', 'CheckoutController@autoCharge');
});
...
Route::group(['namespace' => '\Acelle\Http\Controllers', 'namespace' => '\Acelle\Http\Controllers', 'middleware' => ['not_installed', 'auth', 'frontend', 'subscription', '2fa']], function () {
    ...
    // Subscriber
    Route::post('lists/{list_uid}/subscribers/move-to-blacklist', 'SubscriberController@moveToBlacklist');
    ...
    // Campaign
    Route::post('campaigns/archive', 'CampaignController@archive');
    ...
    Route::post('campaigns/{uid}/remove-attachment/{attachment_uid}', 'CampaignController@removeAttachment');
    Route::get('campaigns/{uid}/download-attachment/{attachment_uid}', 'CampaignController@downloadAttachment');
    ...
    // Automation2
    Route::match(['get', 'post'], 'automation/{uid}/{http_config_uid}/test', 'Automation2Controller@outgoingWebhookTest');
    ...
    Route::post('automation/{uid}/outgoing-webhook/{http_config_uid}/save', 'Automation2Controller@outgoingWebhookSave');
    Route::get('automation/{uid}/outgoing-webhook/{http_config_uid}/setup', 'Automation2Controller@outgoingWebhookSetup');
    ...
    Route::match(['get', 'post'], 'automation/{uid}/wait-until/edit', 'Automation2Controller@waitUntilEdit');
    Route::get('automation/{uid}/wait-until/create', 'Automation2Controller@waitUntilCreate');
    Route::post('automation/{uid}/wait-until/save', 'Automation2Controller@waitUntilSave');
    ...
    Route::post('account/email-plan-verifications/invoices/{uid}/abort', 'EmailVerificationPlanController@invoiceAbort');
    Route::post('account/email-plan-verifications/{plan_uid}/buy', 'EmailVerificationPlanController@buy');
    Route::get('account/email-plan-verifications/select', 'EmailVerificationPlanController@select');
    Route::get('account/email-plan-verifications/transactions/list', 'EmailVerificationPlanController@transactionList');
    Route::get('account/email-plan-verifications/invoices/list', 'EmailVerificationPlanController@invoiceList');
    Route::get('account/email-plan-verifications', 'EmailVerificationPlanController@index');

    // Plan Verification
    Route::post('account/plan-verifications/change-plan/{plan_uid}', 'PlanVerificationController@changePlan');
    Route::get('account/plan-verifications/susbcription/list', 'PlanVerificationController@subscriptionList');
    Route::post('account/plan-verifications/{plan_uid}/buy', 'PlanVerificationController@assignPlan');
    Route::get('account/plan-verifications/select', 'PlanVerificationController@select');
    ...
    // HttpConfig
    Route::get('http-config/http-request/{id}/logs', 'HttpConfigController@httpRequestLogs');
    Route::get('http-config/http-request/{id}/logs/list', 'HttpConfigController@httpRequestLogsList');
    Route::get('http-config/{id}/http-requests', 'HttpConfigController@httpRequests');
    Route::get('http-config/{id}/http-requests/list', 'HttpConfigController@httpRequestsList');
    Route::match(['get', 'post'], 'http_configs/{uid}/test', 'HttpConfigController@test');

    // Payment Method
    Route::post('payment-method/{uid}/delete', 'PaymentMethodController@delete');

    // subscription poup
    Route::post('/subscription/{uid}/cancel-now', 'SubscriptionPopupController@cancelNow');
    Route::post('/subscription/{uid}/enable-recurring', 'SubscriptionPopupController@enableRecurring');
    Route::post('/subscription/{uid}/disable-recurring', 'SubscriptionPopupController@disableRecurring');
    Route::get('/subscription/{uid}/popup', 'SubscriptionPopupController@index');
});
...
Route::group(['namespace' => '\Acelle\Http\Controllers\Admin', 'middleware' => ['not_installed', 'auth', 'backend', '2fa']], function () {
    ...
    Route::get('admin/email-plan-verifications/delete/confirm', 'EmailVerificationPlanController@deleteConfirm');
    Route::post('admin/email-plan-verifications/{uid}/visibility/on', 'EmailVerificationPlanController@visibilityOn');
    Route::post('admin/email-plan-verifications/{uid}/visibility/off', 'EmailVerificationPlanController@visibilityOff');
    Route::post('admin/email-plan-verifications/{uid}/delete', 'EmailVerificationPlanController@delete');
    Route::match(['get', 'post'], 'admin/email-plan-verifications/billing-cycle/custom', 'EmailVerificationPlanController@billingCycleCustom');
    Route::get('admin/email-plan-verifications/list', 'EmailVerificationPlanController@list');
    Route::resource('admin/email-plan-verifications', 'EmailVerificationPlanController');
    ...
    // HttpCConfig
    Route::get('admin/http-config/http-request/{id}/logs', 'HttpConfigController@httpRequestLogs');
    Route::get('admin/http-config/http-request/{id}/logs/list', 'HttpConfigController@httpRequestLogsList');
    Route::get('admin/http-config/{id}/http-requests', 'HttpConfigController@httpRequests');
    Route::get('admin/http-config/{id}/http-requests/list', 'HttpConfigController@httpRequestsList');
    Route::match(['get', 'post'], 'admin/http_configs/{uid}/test', 'HttpConfigController@test');
    ...
    // Payment Gateways
    Route::get('admin/payment-gateways/settings', 'PaymentGatewayController@settings');
    Route::get('admin/payment-gateways/list/{page?}', 'PaymentGatewayController@list');
    Route::match(['get', 'post'], 'admin/payment-gateways/select-type', 'PaymentGatewayController@selectType');
    Route::get('admin/payment-gateways', 'PaymentGatewayController@index');
    Route::get('admin/payment-gateways/create/{type}', 'PaymentGatewayController@create');
    Route::post('admin/payment-gateways/store/{type}', 'PaymentGatewayController@store');
    Route::get('admin/payment-gateways/{uid}/edit', 'PaymentGatewayController@edit');
    Route::patch('admin/payment-gateways/{uid}/update', 'PaymentGatewayController@update');
    Route::post('admin/payment-gateways/{uid}/delete', 'PaymentGatewayController@delete');
    Route::post('admin/payment-gateways/{uid}/disable', 'PaymentGatewayController@disable');
    Route::post('admin/payment-gateways/{uid}/enable', 'PaymentGatewayController@enable');

    // PlanVerification
    Route::post('admin/plan-verifications/{uid}/visible/on', 'PlanVerificationController@visibleOn');
    Route::post('admin/plan-verifications/{uid}/visible/off', 'PlanVerificationController@visibleOff');
    Route::post('admin/plan-verifications/{uid}/delete', 'PlanVerificationController@delete');
    Route::match(['get', 'post'], 'admin/plan-verifications/billing-cycle/custom', 'PlanVerificationController@billingCycleCustom');
    Route::get('admin/plan-verifications/list', 'PlanVerificationController@list');
    Route::resource('admin/plan-verifications', 'PlanVerificationController');
});
