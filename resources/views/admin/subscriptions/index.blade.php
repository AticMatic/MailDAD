                    ...
                    <div class="filter-box">
                        ...
                        <span class="filter-group">
                            <select class="select" name="type">
                                <option value="">{{ trans('messages.plan.all_type') }}</option>
                                <option value="{{ Acelle\Model\PlanGeneral::TYPE_GENERAL }}">{{ trans('messages.plan.type.general') }}</option>
                                <option value="{{ Acelle\Model\PlanVerification::TYPE_VERIFICATION }}">{{ trans('messages.plan.type.verification') }}</option>
                            </select>
                        </span>
                    </div>
                @endif
