...
@section('content')
    ...
    <div class="d-flex">
        <div class="pe-4 pe-lg-5"><p>{{ trans('messages.email_verification_plan.one_time_pay.intro') }}</p></div>
        <div>
            @can('create', new Acelle\Model\PlanGeneral())
                <div class="text-end text-nowrap">
                    <a href="{{ action('Admin\EmailVerificationPlanController@create') }}" role="button" class="btn btn-primary">
