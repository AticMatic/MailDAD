...
@endif
    ...
    <div class="mc_section">
        <div class="row">
            @if (isset($emailit) && !is_null($emailit))
                <div class="col-md-8">
                    <div class="alert alert-success" style="">
                        <div style="display: flex; flex-direction: row; align-items: center;">
                            <div style="">
                                <h4 class="mb-1">{{ trans('messages.sending_server.emailit.webhook_title') }}</h4>
                                <p>{{ trans('messages.sending_server.emailit.webhook_description') }}<br><a target="_blank" href="{{ $webhook }}">{{ $webhook }}</a>
                                </p>
                            </div>
                        </div>
                    </div>
