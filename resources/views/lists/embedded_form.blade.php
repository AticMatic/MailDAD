                ...
                <div style="position:sticky;top:10px;">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                            ...
                            @php
                                $content = (view("lists._embedded_form_content", [
                                    'list' => $list,
                                ])->render());
                                // 
                                $escapedHTML = htmlspecialchars_decode($content, ENT_QUOTES);
                            @endphp
                            <code style="height: 400px" class="form-control main-code hide">{!! $escapedHTML !!}</code>
                        </div>
                    </div>
