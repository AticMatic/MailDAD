...
@section('content')
    ...
    <script>
        ...
        var waitUntilCreateUrl = '{{ action('Automation2Controller@waitUntilCreate', $automation->uid) }}';
        ...
        var waitUntilEditUrl = '{{ action('Automation2Controller@waitUntilEdit', $automation->uid) }}';
            ...
            tree = AutomationElement.fromJson(json, document.getElementById('svg'), {
                ...
                onadd: function(e) {
                    ...
                    MyAutomation.addToTree = function(element) {
                        e.insert(element);
                        e.getTrigger().resolveOverlap();
                        e.getTrigger().moveToCenter();
        ...
        function openCreateWaitUntilActionPopup(key) {
            var url = waitUntilCreateUrl + '?key=' + key;
        ...
        function loadSidebarWaitUntil(id) {
            var url = waitUntilEditUrl + '?id=' + id;
        ...
        function doSelectTreeElement(e) {
            ...
            // is WAIT UNTIL
            else if (e.getType() == 'ElementWaitUntil') {
                    // load sidebar
                    loadSidebarWaitUntil(e.getId());
            }
            // is Condition
