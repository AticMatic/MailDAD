...
>
    ...
    @foreach ($items as $key => $item)
        <tr>
            ...
            <td>
                <span class="no-margin kq_search">{{ $item->feedback_raw }}</span>
            ...
            <td>
                <span class="no-margin kq_search">{{ $item->created_at ?? Auth::user()->customer->formatDateTime($item->created_at, 'datetime_full') }}</span>
