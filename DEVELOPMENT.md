...
#7. Set appropriate DISTRIBUTED_MASTER value
Set its value to true in Master instance and to false in Worker ones

#8. Make sure the Worker instance does not execute jobs of 'default' queue
...
##9.1. Example of Master instance supervisor config
...
##9.2. Example of Worker instance supervisor config
